// TEMPLATE FILE — copied from the proven, working
// games/aurion/core/games/aurion.js. When you clone this into a new series
// folder, update this comment to that folder's real repo path, e.g.
// games/aurion/<new-series>/games/aurion.js.
// Do not remove or "simplify" anything in this file when cloning it — copy
// it exactly as-is, capabilities included (e.g. video preload), even if
// the new series' config doesn't use every capability yet.
