// Repo path: games/setting-the-stage/admin.js
// TEMPLATE — neutral master copy, not tied to Aurion or any character.
// To use for a new character: copy this whole folder into that character's
// own admin/ folder, then edit the two CHANGE THIS lines below.

const REPO_OWNER = 'Anica-blip';
const REPO_NAME = '3c-game-loader';
const CONFIG_DIR = 'games/CHANGE_THIS/config'; // CHANGE THIS: the new character's folder name
